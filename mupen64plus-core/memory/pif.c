...
{
	//printf("Control:%d, Present:%d, Command:%d\n", Control,Controls[Control].Present, Command[2] );fflush(stdout);
	//For some reason, 129 is sent when reading the keys. Something isnt clearing 0x80 in Command[2]
	//I'm going to assume this is something to do with initialization, and me not using SDL...
   switch (Command[2])
   {
   	   case 1:
   	   case 129:
   		   //printf("Control:%d, Present:%d...\n", Control,Controls[Control].Present );fflush(stdout);
